...
public class MessageController {
    ...
    public Map<String, Object> getNotice(User user, String noticeType) {
        Map<String, Object> messageVO = new HashMap<>();
        Message message = messageService.findLatestNotice(user.getId(), noticeType);
        if (message != null) {
            ...
            if (!noticeType.equals(constant.TOPIC_FOLLOW))
                messageVO.put("postId", data.get("postId"));

            int count = messageService.findNoticeCount(user.getId(), noticeType);
            messageVO.put("count", count);

            int unread = messageService.findNoticeUnreadCount(user.getId(), noticeType);
