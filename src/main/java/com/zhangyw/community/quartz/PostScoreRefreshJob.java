package com.zhangyw.community.quartz;
...
public class PostScoreRefreshJob implements Job {
    ...
    static {
        try {
            ...
            throw new RuntimeException("初始化epoch失败!", e);
        }
    }
    ...
    private void refresh(int postId) {
        ...
        // 是否精华
        boolean isDigestedPost = post.getStatus() == 1;
        // 评论数量
        ...
        // 计算权重
        double w = (isDigestedPost ? 75 : 0) + commentCount * 10 + likeCount * 2;
        // 分数 = 帖子权重 + 距离天数
